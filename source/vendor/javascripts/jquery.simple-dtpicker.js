 ...
 *
 * icambron - minor changes to make it work better with bootstrap and font-awesome
 */
 ...
 (function($) {
    ...
    $($picker).trigger("dateChange", {date: date});
		...
		/* Set height to Timelist (Calendar innerHeight) */
